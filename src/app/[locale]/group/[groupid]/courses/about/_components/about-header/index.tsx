...
export function AboutHeader({ groupid, courseId, name, description, thumbnail }: AboutHeaderProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
      ...
      <div className="lg:col-span-4">
        <Card className={cn("relative overflow-hidden rounded-xl border-themeGray bg-[#121315] p-0")}> 
