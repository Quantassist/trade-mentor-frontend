    ...
    <HydrationBoundary state={dehydrate(query)}>
      <div className="py-8 px-4 md:px-8 max-w-4xl mx-auto">
        <div className="flex items-center gap-3 mb-8">
          <div className="h-12 w-12 rounded-xl bg-[#161a20] border border-themeGray/60 flex items-center justify-center">
            <Bookmark size={24} className="text-[#b9a9ff]" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-white">Saved Posts</h1>
            <p className="text-sm text-themeTextGray">Your bookmarked posts for later reading</p>
          </div>
        </div>
