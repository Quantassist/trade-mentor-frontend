...
import { AboutAsideCard } from "@/app/[locale]/group/[groupid]/courses/_components/about-aside-card"
import { AboutFaq } from "@/app/[locale]/group/[groupid]/courses/_components/about-faq"
import { AboutHeader } from "@/app/[locale]/group/[groupid]/courses/_components/about-header"
import { AboutLearn } from "@/app/[locale]/group/[groupid]/courses/_components/about-learn"
import { AboutMentor } from "@/app/[locale]/group/[groupid]/courses/_components/about-mentor"
import { AboutMetrics } from "@/app/[locale]/group/[groupid]/courses/_components/about-metrics"
import { AboutModules } from "@/app/[locale]/group/[groupid]/courses/_components/about-modules"
...
export default async function AboutCoursePage({ params }: PageProps) {
  ...
  return (
    <HydrationBoundary state={dehydrate(client)}>
      <div className="container mx-auto pt-28 max-w-6xl py-10 px-5 md:px-10 pb-24 lg:pb-10">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            {course?.description && (
              <section className="space-y-2">
                ...
                <p className="text-slate-500 dark:text-themeTextGray leading-relaxed max-w-3xl">{course.description}</p>
              </section>
            )}
