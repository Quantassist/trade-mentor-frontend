    ...
    return (
      <section className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-semibold text-white">Discussion Channels</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[1, 2, 3].map((i) => (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-lg bg-themeGray/40" />
                <div className="flex-1 space-y-2">
                  <div className="h-4 bg-themeGray/40 rounded w-2/3" />
                  <div className="h-3 bg-themeGray/40 rounded w-1/2" />
                </div>
              </div>
            </div>
          ))}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {channels.map((channel: any) => {
          ...
          return (
            ...
            >
              <Card className="bg-[#161a20] border-themeGray/60 rounded-xl p-4 group transition-all duration-200 hover:bg-[#1e2329] hover:border-themeGray/80 hover:shadow-lg hover:shadow-black/20 cursor-pointer h-full">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-white font-medium truncate group-hover:text-[#d4f0e7] transition-colors capitalize">
                      #{channel.name}
                    </h3>
                  ...
                  <div className="text-themeTextGray/50 group-hover:text-[#b9a9ff] transition-colors">
                    <svg
                      className="h-5 w-5"
                      fill="none"
                      viewBox="0 0 24 24"
